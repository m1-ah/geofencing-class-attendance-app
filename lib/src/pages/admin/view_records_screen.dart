...
//
//   Future<void> fetchAdminData() async {
//     var adminDoc = await FirebaseFirestore.instance.collection('admins').doc(user?.uid).get();
//     if (adminDoc.exists) {
//       setState(() {
//         adminName = adminDoc["name"];
//         adminUID = adminDoc["adminUID"];
...
//
//   Future<void> fetchClassesCreated() async {
//     var classQuery = await FirebaseFirestore.instance.collection('classes').where("adminUID", isEqualTo: user?.uid).get();
//     setState(() {
//       totalClassesCreated = classQuery.docs.length;
//     });
//   }
...
//     return FirebaseFirestore.instance
//         .collection('attendance')
//         .where("adminUID", isEqualTo: adminUID)  // Ensure user?.uid is correct
//         .snapshots();
//   }
//
//
...
//                 child: Column(
//                   children: [
//                     Text(adminName, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF0A0A23))),
//                     Text(adminUID, style: TextStyle(fontSize: 18, color: Color(0xFF0A0A23))),
//                     SizedBox(height: 8),
//                     Text("Classes Created: $totalClassesCreated", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF0A0A23))),
//                   ],
//                 ),
//               ),
//             ),
...
//                             crossAxisAlignment: CrossAxisAlignment.start,
//                             children: [
//                               Text("Institution: ${doc['institution']}", style: TextStyle(fontSize: 14)),
//                               Text("Year: ${doc['yearOfStudy']}", style: TextStyle(fontSize: 14)),
//                             ],
//                           ),
//                         ),
//                       );
